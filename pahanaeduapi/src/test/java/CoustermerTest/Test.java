...
public class Test {
    ...
    public void testCreateUpdateDeleteCustomer() {
       ...
       customer.setAccountNumber("CUST-1005");
...
customer.setRegisteredDate(java.sql.Date.valueOf(today));
        ...
        assertTrue(created);
        assertTrue("CUST-1005".equals(customer.getAccountNumber()));
        ...
        //boolean deleted = customerOPR.deleteCustomer(customer.getName(""));
    ...
    public void testGetItemById() {
        com.mycompany.customerapi.model.Item item = ItemOPR.getItemById(6);
        assertNotNull(item);
